...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // Get content, embeds, and attachments
            ...
            console.error(error);
            interaction.reply({ content: 'Failed to fetch or send the message. Make sure the channel and ID are correct and that the bot has permissions.', ephemeral: true });
        }
    },
    ...
    async prefixExecute(message, args) {
        ...
        try {
            ...
            console.error(error);
            message.channel.send('Failed to fetch or send the message. Make sure the channel and ID are correct and that the bot has permissions.');
        }
    }
};
